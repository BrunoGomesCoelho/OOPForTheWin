...
public class Manipulate {
	...
	/**
	 * Função para normalização de um valor n, do intervalo [min, max] para [a, b];
	 * Quais valores servem de entrada, desde que min != max e min < max
	 * 
	 * @param n - valor de análise
	 ...
	 * @param sizeX - dimensões da nova imagem, sendo > 0
	 * @param sizeY - dimensões da nova imagem, sendo > 0
	 ...
	 * 
	 * @param srcImage - imagem original
	 * @param percent - fator de escala. se percent == 0.75 a nova imagem será 75% menor que a original
	 * @return imagem redimensionada
	 */
	...
	/**
	 * Método que retorna se um ponto está ou não contido em uma imagem img
	 * 
	...
	/**
	 * @param srcImage - Imagem original
	 * @param angle - ângulo da rotação - pode ser qualquer valor de double
	...
	/**
	 * Método que estica uma imagem de acordo com um tamanho passado por parâmetro.
	 * 
	 * @param srcImage - imagem original
	 * @param size - nova dimensão da imagem esticada (maior que 0).
	 * @param dir - direção na qual a imagem será esticada (horizontal ou vertical)
	...
	/**
	 * Método que espelha uma imagem de acordo a direção dada.
	 * 
	 * @param srcImage - imagem original
	 * @param dir - direção na qual a imagem será espelhada (horizontal, vertical ou diagonal)
	 * @return imagem modificada
	 */
	...
	/**
	 * Método de recorte direto da imagem, através da classe RegionModel
	 * 
	 * @param srcImage
	 * @param r - região que será cortada
	 * @return imagem com a região destacada
	 */
	...
	/**
	 * Método que, dado um ponto (x, y) contido na imagem, seleciona e recorta uma região da imagem
	 * baseada na semelhança por cor.
	 * 
	 * @param srcImage - imagem original
	 * @param x - coordenadas do ponto
	 * @param y - coordenadas do ponto
	 * @param level - nível de detalhe do recorte. 0 à 8 (ordem de detalhe decrescente)
	 * @return imagem com a região selecionada
	 */
